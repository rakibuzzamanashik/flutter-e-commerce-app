...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future addToCart() async {
    ...
    return _collectionRef.doc(currentUser!.email).collection("items").doc(widget._product["product-name"]).set({
              ...
              return Padding(
                ...
                child: CircleAvatar(
                  ...
                  child: IconButton(
                    ...
                    icon: snapshot.data.docs.length==0? Icon(Icons.favorite_outline, color: Colors.white,
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            AspectRatio(aspectRatio: 2, child: Image.network(widget._product["product-img"],)),
